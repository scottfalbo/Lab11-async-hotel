    ...
    public partial class userauth : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Estes Park", "United States", "The Overlook", "833-888-0237", "Colorado", "333 Wonderview Avenue" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "permissions", "update", "district manager" },
                    { 3, "permissions", "delete", "district manager" },
                    { 4, "permissions", "create", "property manager" },
                    { 5, "permissions", "update", "property manager" },
                    { 6, "permissions", "delete", "property manager" },
                    { 7, "permissions", "create", "agent" },
                    { 8, "permissions", "update", "agent" },
                    { 9, "permissions", "delete", "agent" }
                });
